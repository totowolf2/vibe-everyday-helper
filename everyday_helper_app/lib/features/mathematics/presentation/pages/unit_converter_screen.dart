...
class _UnitConverterViewState extends State<_UnitConverterView> {
  ...
  void initState() {
    ...
    _inputController.addListener(() {
      context.read<UnitConverterViewModel>().updateInputValue(_inputController.text);
    });
  }
                ...
                return Wrap(
                  ...
                  children: UnitCategory.values.map((category) {
                    ...
                    return FilterChip(
                      ...
                      backgroundColor: isSelected ? theme.colorScheme.tertiaryContainer : null,
                  ...
                  children: [
                    Expanded(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          viewModel.outputValue.isEmpty ? '0' : viewModel.outputValue,
  ...
  Widget _buildResultsDisplay(BuildContext context, UnitConverterViewModel viewModel) {
  ...
  Widget _buildMainResultCard(BuildContext context, UnitConverterViewModel viewModel) {
    final theme = Theme.of(context);
  ...
  Widget _buildDetailedResults(BuildContext context, UnitConverterViewModel viewModel) {
    final theme = Theme.of(context);
  ...
  Widget _buildQuickConversions(BuildContext context, UnitConverterViewModel viewModel) {
    final theme = Theme.of(context);
  ...
  Widget _buildHistoryCard(BuildContext context, UnitConverterViewModel viewModel) {
    final theme = Theme.of(context);
  ...
  Widget _buildInstructionsDisplay(BuildContext context, UnitConverterViewModel viewModel) {
    final theme = Theme.of(context);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: AppConstants.defaultPadding),
              const Text(
                '1. Select a category (Length, Weight, Volume, etc.)\n'
                '2. Choose units to convert from and to\n'
                '3. Enter a value to see the conversion',
